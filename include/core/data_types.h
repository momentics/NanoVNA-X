...
enum stimulus_type { ST_START = 0, ST_STOP, ST_CENTER, ST_CW, ST_SPAN, ST_STEP, ST_VAR };
#endif
...
#define RECTANGULAR_GRID_MASK                                                                      \
  ((1 << TRC_LOGMAG) | (1 << TRC_PHASE) | (1 << TRC_DELAY) | (1 << TRC_LINEAR) | (1 << TRC_SWR) |  \
   (1 << TRC_REAL) | (1 << TRC_IMAG) | (1 << TRC_R) | (1 << TRC_X) | (1 << TRC_Z) |                \
   (1 << TRC_ZPHASE) | (1 << TRC_G) | (1 << TRC_B) | (1 << TRC_Y) | (1 << TRC_Rp) |                \
   (1 << TRC_Xp) | (1 << TRC_Cs) | (1 << TRC_Ls) | (1 << TRC_Cp) | (1 << TRC_Lp) | (1 << TRC_Q) |  \
   (1 << TRC_Rser) | (1 << TRC_Xser) | (1 << TRC_Zser) | (1 << TRC_Rsh) | (1 << TRC_Xsh) |         \
   (1 << TRC_Zsh) | (1 << TRC_Qs21))
...
#define NANO_TYPE_MASK                                                                             \
  ((1 << TRC_DELAY) | (1 << TRC_Cs) | (1 << TRC_Ls) | (1 << TRC_Cp) | (1 << TRC_Lp))
// Universal trace type for both channels
#define S11_AND_S21_TYPE_MASK                                                                      \
  ((1 << TRC_LOGMAG) | (1 << TRC_PHASE) | (1 << TRC_DELAY) | (1 << TRC_LINEAR) | (1 << TRC_REAL) | \
   (1 << TRC_IMAG) | (1 << TRC_POLAR) | (1 << TRC_SMITH))
...
typedef struct trace_info {
  ...
  get_value_cb_t
    get_value_cb; // get value callback (can be NULL, in this case need add custom calculations)
} trace_info_t;
...
#define ADMIT_MARKER_VALUE(v)                                                                      \
  ((1 << (v)) & ((1 << MS_GB) | (1 << MS_GLC) | (1 << MS_RpXp) | (1 << MS_RpLC)))
#define LC_MARKER_VALUE(v)                                                                         \
  ((1 << (v)) &                                                                                    \
   ((1 << MS_RLC) | (1 << MS_GLC) | (1 << MS_RpLC) | (1 << MS_SHUNT_RLC) | (1 << MS_SERIES_RLC)))

#define S11_SMITH_VALUE(v)                                                                         \
  ((1 << (v)) & ((1 << MS_LIN) | (1 << MS_LOG) | (1 << MS_REIM) | (1 << MS_RX) | (1 << MS_RLC) |   \
                 (1 << MS_GB) | (1 << MS_GLC) | (1 << MS_RpXp) | (1 << MS_RpLC)))
#define S21_SMITH_VALUE(v)                                                                         \
  ((1 << (v)) & ((1 << MS_LIN) | (1 << MS_LOG) | (1 << MS_REIM) | (1 << MS_SHUNT_RX) |             \
                 (1 << MS_SHUNT_RLC) | (1 << MS_SERIES_RX) | (1 << MS_SERIES_RLC)))
...
typedef struct {
  ...
  get_value_cb_t
    get_im_cb; // get imag value callback (can be NULL, in this case need add custom calculations)
} marker_info_t;
...
typedef struct properties {
  ...
  float _cal_load_r; // Used as calibration standard LOAD R value (calculated in renormalization
                     // procedure)
  uint32_t _reserved1[5];
  float _cal_data[CAL_TYPE_COUNT][SWEEP_POINTS_MAX]
                 [2]; // Put at the end for faster access to others data from struct
  uint32_t checksum;
} properties_t;
