...
| `src/platform`, `boards/nanovna` | Платы и аппаратно-зависимый код (объединённый BSP для STM32F072/STM32F303), общий с ChibiOS. |
