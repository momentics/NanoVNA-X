 ...
 *
 * @note    ChibiOS 21.11.x removed the STM32_NO_BACKUP_DOMAIN_INIT guard
 *          used by this project for VNA_AUTO_SELECT_RTC_SOURCE.
 * @note    Local copy placed under boards/ to avoid patching the vendor tree.
 */
#if !defined(STM32_NO_BACKUP_DOMAIN_INIT)
...
#endif /* !defined(STM32_NO_BACKUP_DOMAIN_INIT) */
