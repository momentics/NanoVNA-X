...
* **License texts:** The repository now includes `LICENSE`, `LICENSES/Apache-2.0.txt`, and `LICENSES/BSD-3-Clause-ARM_ST.txt`, ensuring that all required license texts accompany binary or source distributions.【F:LICENSE†L1-L18】【F:LICENSES/Apache-2.0.txt†L1-L114】【F:LICENSES/BSD-3-Clause-ARM_ST.txt†L1-L24】
