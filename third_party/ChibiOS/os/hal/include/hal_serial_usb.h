...
#define _serial_usb_driver_data                                             \
  ...
  /* Input buffer.*/                                                        \
  uint8_t                   ib[BQ_BUFFER_SIZE(SERIAL_USB_RX_BUFFERS_NUMBER, \
                                              SERIAL_USB_RX_BUFFERS_SIZE)]; \
  /* Output buffer.*/                                                       \
  uint8_t                   ob[BQ_BUFFER_SIZE(SERIAL_USB_TX_BUFFERS_NUMBER, \
                                              SERIAL_USB_TX_BUFFERS_SIZE)]; \
