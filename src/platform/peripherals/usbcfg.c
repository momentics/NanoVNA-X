...
static void usb_event(USBDriver *usbp, usbevent_t event) {
  ...
  case USB_EVENT_CONFIGURED:
    ...
    sduConfigureHookI(&sd_u1);
    break;
  case USB_EVENT_SUSPEND:
    /* Disconnection event on suspend.*/
    sduDisconnectI(&sd_u1);
 ...
 */
bool custom_sdu_requests_hook(USBDriver *usbp) {
 ...
 */
const USBConfig USBCFG = {usb_event, get_descriptor, custom_sdu_requests_hook, sof_handler};
